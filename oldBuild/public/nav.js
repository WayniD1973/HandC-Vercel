if (document.currentScript.getAttribute('navType') == 'normal') {
	...
	document.querySelector('head').innerHTML += '<link rel="shortcut icon" href="/Logo.png">';
	document.querySelector('head').insertAdjacentHTML('afterbegin', '<script src="/cookies.js"></script>');
